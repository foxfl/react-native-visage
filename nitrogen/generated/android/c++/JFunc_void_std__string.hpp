...
namespace margelo::nitro::visage {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void_std__string_cxx;";

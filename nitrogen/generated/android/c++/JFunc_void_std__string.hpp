...
namespace margelo::nitro::visage {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void_std__string;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void_std__string_cxx;";

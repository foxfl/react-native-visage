...
namespace margelo::nitro::visage {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void_cxx;";

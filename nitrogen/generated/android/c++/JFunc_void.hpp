...
namespace margelo::nitro::visage {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/visage/Func_void_cxx;";

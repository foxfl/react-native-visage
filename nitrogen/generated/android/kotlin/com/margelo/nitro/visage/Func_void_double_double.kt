...
/**
 * Represents the JavaScript callback `(scanned: number, total: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(scanned: Double, total: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(scanned: Double, total: Double): Unit
    = invoke_cxx(scanned,total)

  @FastNative
  private external fun invoke_cxx(scanned: Double, total: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(scanned: Double, total: Double): Unit {
    return this.function(scanned, total)
  }
}

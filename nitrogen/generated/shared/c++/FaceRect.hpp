...
namespace margelo::nitro::visage {
  ...
  /**
   * A struct which can be represented as a JavaScript object (FaceRect).
   */
  struct FaceRect final {
  public:
  ...
  public:
    FaceRect() = default;
    explicit FaceRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const FaceRect& lhs, const FaceRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ FaceRect <> JS FaceRect (object)
  template <>
  struct JSIConverter<margelo::nitro::visage::FaceRect> final {
    static inline margelo::nitro::visage::FaceRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::visage::FaceRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::visage::FaceRect& arg) {

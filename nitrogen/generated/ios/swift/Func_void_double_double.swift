...
/**
 * Wraps a Swift `(_ scanned: Double, _ total: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double_double {
  public typealias bridge = margelo.nitro.visage.bridge.swift

  private let closure: (_ scanned: Double, _ total: Double) -> Void

  public init(_ closure: @escaping (_ scanned: Double, _ total: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(scanned: Double, total: Double) -> Void {
    self.closure(scanned, total)
  }
